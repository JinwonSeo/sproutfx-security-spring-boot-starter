package kr.sproutfx.common.sproutfxcommonsecurityspringbootstarter.configuration.authorization.filter;
...
public class HttpFirewallFilter extends StrictHttpFirewall
{
    ...
    // Logger
    private static final Logger LOGGER = Logger.getLogger(HttpFirewallFilter.class.getName());

    // Default constructor
    public HttpFirewallFilter()
    {
        super();
    }
    ...
    public FirewalledRequest getFirewalledRequest(final HttpServletRequest request)
    {
        try
        {
            // Perform any additional checks that the naive "StrictHttpFirewall" misses.
            ...
            else
            {
                ...
                if (LOGGER.isLoggable(Level.WARNING))
                {
                    ...
                    (
                        ...
                        String.format
                        (
                            "Intercepted RequestBlockedException: Remote Host: %s, User Agent: %s, Request URL: %s",
